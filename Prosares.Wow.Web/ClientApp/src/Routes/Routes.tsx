            ...
            <div className="main-content">
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <Protected permittedPages={"TimesheetMaster"}>
                      <TimeSheetPolicy />
                    </Protected>
                  }
                />
                ...
                <Route
                  ...
                  element={
                    <Protected permittedPages={"TimesheetMasterEdit"}>
                      <TimeSheetPolicyEdit />
                    </Protected>
                  }
                />
                ...
                {/* Reports */}
                <Route
                  path={`${env}/report/capacityutilization`}
                  element={
                    <Protected permittedPages={"CapacityUtilizationReport"}>
